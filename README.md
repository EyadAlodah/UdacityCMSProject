...
| ------------ | ------------ | ------------ |
| *Azure Postgres Database* |  Basic   |  54.64 USD|
| *Azure Service Bus*   |    Basic     |     50 USD         | 
| *Function App*    |     Basic    |      18 USD       |
| *Web App*    |     Basic    |      13 USD       |

Total Esimated Price Per Month : 135.64 USD
...
azure:
1. Azure Web app: it will contain the website files
2. Azure PostgresSQL: the conference data
3. Azure Functions and azure service bus queue: Refactoring the existing method for sending emails to attendees to a background task.
